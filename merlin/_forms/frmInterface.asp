...
%>
	...
	<tr height="80">
	<td width="800" bgcolor="#FFFFFF"><a href="<% =sApplicationHomePath & sTempParams %>"><img src="<% =sHomePath %>image/merlin_header2.png" width="276" height="110" border="0" vspace="8" hspace="28"></a></td>
	<td>
		<% If iUserID>0 Then %>
...
If Not iUserAdmin=1 Then Exit Sub
