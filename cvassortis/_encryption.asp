<%
Const aExtraSalt = "D@m75oP924s6d4$$EZs4%65Ad4s5q!dp8er"
...
Class CEncryption
	...
	Public Function Sha1Encode(sText)
		Sha1Encode = str_sha1(sText)
	End Function

	Public Function HexSha1Encode(sText)
		HexSha1Encode = hex_sha1(sText)
	End Function

	Public Function Sha1EncodeWithSalt(sText)
		Sha1EncodeWithSalt = Sha1Encode(Sha1Encode(sText) & aExtraSalt)
	End Function
	...
	Public Function Base64Sha1Encode(sText)
		Base64Sha1Encode = b64_sha1(sText)
	End Function

	Public Function Base64Sha1EncodeWithSalt(sText)
		Base64Sha1EncodeWithSalt = Base64Sha1Encode(str_sha1(sText) & aExtraSalt)
	End Function

	Public Function GeneratePasswordHash(sPassword)
		Dim sResult
		sResult = Null

		If Len(ReplaceIfEmpty(sPassword, "")) > 0 Then
			sResult = Base64Sha1Encode(str_sha1(sPassword) & aExtraSalt)
		End If

		GeneratePasswordHash = sResult
	End Function

	Public Function USha1Encode(sText)
		USha1Encode = UCase(HexSha1Encode(sText))
	End Function

	%>
	<!-- #include virtual = "/_security/sha1_js.asp" -->
	<!-- #include virtual = "/_security/md5.asp" -->
	<%
