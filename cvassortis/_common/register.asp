...
<% ShowMessageEnd %>
  ...
  <!-- Personal information -->
	...
	<input type="hidden" name="id_Person" value="<% =iPersonID %>">
		...
		<h3><span class="left">&nbsp;</span><span class="right">&nbsp;</span><% =GetLabel(sCvLanguage, "Personal information") %></h3>
...
<% End If %>
		...
		<td class="value blue"><p><% if iGenderID="1" then 
		...
		<% = GetLabel(sCvLanguage, "female") %><% If sApplicationName="expert" Then %>&nbsp;&nbsp;</b><span class="fcmp">*</span><% End If %>&nbsp;</td>
		</tr>
		<tr>
