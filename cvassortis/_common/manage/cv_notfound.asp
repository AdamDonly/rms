...
If Request.Form()>"" Then
	...
	objTempRs=UpdateRecordSPWithConn(objConnMpis, "su.CUSTOML_ALL_ContactDetailFoundUpdate", Array( _
		Array(, adInteger, , iContactID), _
		Array(, adInteger, , iContactNotFound), _
...
If Not objTempRs.Eof Then 
	...
	iContactNotFound=objTempRs("CONTACT_DETAILS_NOTFOUND")
	sContactComments=objTempRs("CONTACT_DETAILS_COMMENTS")
...
<div id="holder">
	...
	<div id="content" class="searchform">
		...
		<h2 class="service_title">Curriculum Vitae. <span class="service_slogan">No contact details</span></h2>
	...
	<input type="hidden" name="id_contact" value="<%=iContactID%>">
		...
		<td class="value blue"><input type="checkbox" name="cnt_notfound" id="cnt_notfound" <% If iContactNotFound=1 Then %> checked<% End If %>><label for="cnt_notfound">&nbsp;Contact details cannot be found</label></td>
		</tr>
		<tr class="last">
