...
<% ShowTopMenu %>
  ...
  <!-- Personal information -->
	<% InputFormHeader 580, "PROJECT REGISTRATION" %>
	...
	<input type="hidden" name="idproject" value="<% =objProject.ID %>">
		...
		<% InputBlockElementLeftStart %><p class="ftxt">Project&nbsp;status</p><% InputBlockElementLeftEnd %><% InputBlockElementMiddle %>
		...
		<% InputBlockElementLeftStart %><p class="ftxt">Reference</p><% InputBlockElementLeftEnd %><% InputBlockElementMiddle %>
		...
		<% InputBlockElementLeftStart %><p class="ftxt">Country&nbsp;/&nbsp;Region</p><% InputBlockElementLeftEnd %><% InputBlockElementMiddle %>
		...
		<% InputBlockElementLeftStart %><p class="ftxt">Description</p><% InputBlockElementLeftEnd %><% InputBlockElementMiddle %>
		...
		<% InputBlockElementLeftStart %><p class="ftxt">Deadline</p><% InputBlockElementLeftEnd %><% InputBlockElementMiddle %>
