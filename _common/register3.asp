...
Dim sPageTitle
sPageTitle = GetLabel(sCvLanguage, "CV registration") & ". " & GetLabel(sCvLanguage, "Professional experience")
%>
<!--#include virtual="/_common/_template/html.header.scrolllist.start2.asp"-->
<% InsertJsHelpers 0, 0 %>
<script type="text/javascript" src="/_scripts/js/main.js"></script>
<script language="JavaScript" src="/_scripts/js/asr.js"></script>
<script language="JavaScript" src="/_scripts/js/lib.20230601.js"></script>
<% InsertScrollStyles %>
...
%>
	...
	var mmb_cou = ((f.mmb_cou_hid.value.split(',').length - 1) || 0);
	var mmb_sct = ((f.mmb_sct_hid.value.split(',').length - 1) || 0);
	var mmb_don = ((f.mmb_don_hid.value.split(',').length - 1) || 0);
...
<br />
  <!-- Key qualifications -->
	...
	<tr class="fborder" height="1"><td width=1 bgcolor="<%=colFormHeaderTop%>"></td>
	<td class="fborder2" width=578 bgcolor="<%=colFormHeaderTop%>"></td>
	<td width=1 bgcolor="<%=colFormHeaderBottom%>"></td></tr>
	<tr height=18><td width=1 bgcolor="<%=colFormHeaderTop%>"><img src="<% =sHomePath %>image/x.gif" width=1 height=18></td>
	<td width=578 bgcolor="<%=colFormHeaderMain%>"><p class="fttl"><img src="<% =sHomePath %>image/<% =imgFormBullet %>" width=7 height=7 align=left vspace=3 hspace=8><% =GetLabel(sCvLanguage, "KEY QUALIFICATION AND SPECIFIC EXPERIENCE") %></p></td>
	<td width=1 bgcolor="<%=colFormHeaderBottom%>"><img src="<% =sHomePath %>image/x.gif" width=1 height=18></td></tr>
	<tr class="fborder" height="1"><td width=1 bgcolor="<%=colFormHeaderTop%>"></td>
	<td width=578 bgcolor="<%=colFormHeaderBottom%>"></td>
	<td width=1 bgcolor="<%=colFormHeaderBottom%>"></td></tr>
	<tr class="fborder" height="1"><td width=1 bgcolor="<% =colFormHeaderSplitter %>"></td>
	<td width=578 bgcolor="<% =colFormHeaderSplitter %>"></td>
	<td width=1 bgcolor="<% =colFormHeaderSplitter %>"></td></tr>
	...
	<tr>
	<td width=1 bgcolor="<%=colFormBodyText%>"></td>
	<td width=579 colspan=2 bgcolor="<%=colFormBodyRight%>" valign="top">
		<table width="100%" cellspacing=0 cellpadding=0 border=0>
		<tr>
		<td>
		<table class="list" cellspacing=1 cellpadding=1 width="100%" border=0 bgcolor="<%=colFormBodyRight%>">
		<tr height=20>
		...
		While Not objTempRs.Eof %>
		  <tr height=20>
		    ...
		    <td bgcolor="<%=colFormBodyText%>"><% If objTempRs("id_ExpWke")=iExpPrjID Then %><img src="<% =sHomePath %>image/vn_updte.gif" width=15 height=15 border=0 hspace=0 alt="Updating"><% Else %><a href="register3.asp<%=AddUrlParams(sParams, "prjid=" & objTempRs("id_ExpWke"))%>&act=update"><img src="<% =sHomePath %>image/vn_updt.gif" width=15 height=15 border=0 hspace=0 alt="Update this record"></a><% End If %></td>
		    <td bgcolor="<%=colFormBodyText%>"><a href="register3.asp<%=AddUrlParams(sParams, "prjid=" & objTempRs("id_ExpWke"))%>&act=delete"><img src="<% =sHomePath %>image/vn_del.gif" width=15 height=15 border=0 hspace=0 alt="Delete this record"></a></td>
		  </tr>
		<% i=i+1
		objTempRs.MoveNext
		WEnd %>
...
<!--#include file="../_common/expWorkFields.asp"-->
	...
	<input type="hidden" name="mmb_sct_hid" value=''>
   	...
   	<tr><td width=1 bgcolor="<%=colFormBodyText%>"></td>
	<td width=578 bgcolor="<%=colFormHeaderTop%>" valign="top">
		<table width="100%" cellspacing=0 cellpadding=0 border=0>
		<tr><td width=170><p class="ftxt"><% =GetLabel(sCvLanguage, "Type of experience (Reg)") %></td>
		...
		<tr><td width=170><p class="ftxt"><% =GetLabel(sCvLanguage, "Reference") %>&nbsp;</nobr>(contact&nbsp;person)</br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% =GetLabel(sCvLanguage, "Full name") %></td>
		<td bgcolor="<%=colFormBodyRight%>" width=1><img src="x.gif" width=1 height=24></td>
		<td bgcolor="<%=colFormBodyText%>" width=407>&nbsp;&nbsp;<input type="text" id="exp_ref_name" name="exp_ref_name" size=31 style="width:355px;" maxlength=255 value="<%=sExpRefName%>"><% If sUserType="expert" Then %>&nbsp;&nbsp;<span class="fcmp">*</span>&nbsp;&nbsp;<% End If %></td></tr>

		<tr><td width=170><p class="ftxt">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% =GetLabel(sCvLanguage, "Position") %></td>
		<td bgcolor="<%=colFormBodyRight%>" width=1><img src="x.gif" width=1 height=24></td>
		<td bgcolor="<%=colFormBodyText%>" width=407>&nbsp;&nbsp;<input type="text" id="exp_ref_position" name="exp_ref_position" size=31 style="width:355px;" maxlength=255 value="<%=sExpRefPosition%>"><% If sUserType="expert" Then %>&nbsp;&nbsp;<span class="fcmp">*</span>&nbsp;&nbsp;<% End If %></td></tr>

		<tr><td width=170><p class="ftxt">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% =GetLabel(sCvLanguage, "Phone") %></td>
		<td bgcolor="<%=colFormBodyRight%>" width=1><img src="x.gif" width=1 height=24></td>
		<td bgcolor="<%=colFormBodyText%>" width=407>&nbsp;&nbsp;<input type="text" name="exp_ref_phone" size=31 style="width:355px;" maxlength=150 value="<%=sExpRefPhone%>"><% If sUserType="expert" Then %>&nbsp;&nbsp;<span class="fcmp">*</span>&nbsp;&nbsp;<% End If %></td></tr>

		<tr><td width=170><p class="ftxt">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<% =GetLabel(sCvLanguage, "Email") %></td>
		<td bgcolor="<%=colFormBodyRight%>" width=1><img src="x.gif" width=1 height=24></td>
		<td bgcolor="<%=colFormBodyText%>" width=407>&nbsp;&nbsp;<input type="text" name="exp_ref_email" size=31 style="width:355px;" maxlength=150 value="<%=sExpRefEmail%>"><% If sUserType="expert" Then %>&nbsp;&nbsp;<span class="fcmp">*</span>&nbsp;&nbsp;<% End If %></td></tr>

		<tr><td width=170><p class="ftxt"><% =GetLabel(sCvLanguage, "Other references") %></td>
		<td bgcolor="<%=colFormBodyRight%>" width=1><img src="x.gif" width=1 height=24></td>
		<td bgcolor="<%=colFormBodyText%>" width=407>&nbsp;&nbsp;<input type="text" id="exp_clientref" name="exp_clientref" size=31 style="width:355px;" maxlength=150 value="<% =sExpPrjReferences %>"></td></tr>
	...
	<td width=1 bgcolor="<%=colFormBodyRight%>"></td></tr>

	<tr class="fborder" height="1"><td width=1 bgcolor="<%=colFormBodyText%>"></td>
	<td width=578 bgcolor="<%=colFormHeaderMain%>"></td>
	<td width=1 bgcolor="<%=colFormBodyRight%>"></td></tr>
	<tr class="fborder" height="1"><td width=1 bgcolor="<% =colFormHeaderSplitter %>"></td>
	<td width=578 bgcolor="<% =colFormHeaderSplitter %>"></td>
	<td width=1 bgcolor="<% =colFormHeaderSplitter %>"></td></tr>
		...
		<div class="mini_wraper">
			<%			
			'Funding agancies
			ShowDonScrollBox "<small>" & GetLabel(sCvLanguage, "Select funding agency from list") & "</small>",  "", 1, 0, 0, 0 %><br />
			<%
			' Countries
			ShowCouScrollBox "<small>" & GetLabel(sCvLanguage, "Select project's countries") & "</small>",  "", 1, 0, 1, 1, 0 %><br />
			<%
			' Sectors
			ShowSctScrollBox "<small>" & GetLabel(sCvLanguage, "Select project's sub-sectors") & "</small>",  "", 1, 0, 0 %><br />
		</div>
