...
' SECTORS selector:
Sub ShowSctScrollBox(sBoxTitle, sLeftMenuTitle, bShowLeftMenu, bShowAll, bShowTotal, bShowSectorsSimultaneously)
	%>
	...
	<% If InStr(sScriptFileName, "exp_search") > 0 And bShowSectorsSimultaneously = 1 Then %>
