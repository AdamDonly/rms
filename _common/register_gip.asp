...
<% End If %>
   ...
   <!-- Professional information  -->
	...
	<% InputBlockHeader "100%" %>
		...
		<% InputBlockElementLeftStart %><p class="ftxt">Status</p><% InputBlockElementLeftEnd %><% InputBlockElementMiddle %>
...
-->		
		...
		<% InputBlockElementRightStart %>&nbsp;&nbsp;<input type="text" name="exp_wke_years" size="5" maxlength=2 onBlur="checkNumeric(this, 'Please enter only numbers for your experience', 1)" value="<% =iExperienceYears %>"><% If sApplicationName="expert" Then %>&nbsp;&nbsp;<span class="fcmp">*</span><% End If %>&nbsp;&nbsp;<span class="sml">(<% = GetLabel(sCvLanguage, "use only numbers") %>)</span><% InputBlockElementRightEnd %>
		<% InputBlockSpace 6 %>
	<% InputBlockFooter %>
	<% InputFormFooter %>
	<% InputFormSpace 12 %>
