...
<% If Len(sBackOffice)<3 Then %>
	...
	if (f.exp_edu_subj1.value=="") {
		alert("Please fill in the exact title of the degree."); document.RegForm.exp_edu_subj1.focus(); return;
	}
<% End If %>  
...
<% ShowRegistrationProgressBar "CV", 2 %>
  ...
  <!-- Education -->
	...
	<td width=578 bgcolor="<%=colFormHeaderMain%>"><img src="<% =sHomePath %>image/x.gif" width=498 height=1><br><p class="fttl"><img src="<% =sHomePath %>image/<% =imgFormBullet %>" width=7 height=7 align=left vspace=3 hspace=8><% =GetLabel(sCvLanguage, "EDUCATION") %></p></td>
	...
	<td width=579 colspan=2 bgcolor="<%=colFormBodyRight%>" valign="top">
		...
		<tr height=20>
			<td width=10 bgcolor="<%=colFormHeaderTop%>"><p>N.</td>
			<td width=215 bgcolor="<%=colFormHeaderTop%>"><p><% =GetLabel(sCvLanguage, "Institution ") %></td>
			<td width=60 bgcolor="<%=colFormHeaderTop%>"><p><% =GetLabel(sCvLanguage, "Start date") %></td>
			<td width=60 bgcolor="<%=colFormHeaderTop%>"><p><% =GetLabel(sCvLanguage, "End date") %></td>
			<td width=200 bgcolor="<%=colFormHeaderTop%>"><p><% =GetLabel(sCvLanguage, "Subject") %></td>
	...
	<td width=578 bgcolor="<%=colFormHeaderTop%>" valign="top">
		<table width="100%" cellspacing=0 cellpadding=0 border=0>
		<tr><td width=170><p class="ftxt"><% =GetLabel(sCvLanguage, "Institution name") %></td>
		...
		<tr><td width=170><p class="ftxt"><% =GetLabel(sCvLanguage, "Type of diploma") %></td>
		...
		<tr><td width=170><p class="ftxt"><% =GetLabel(sCvLanguage, "If other please specify") %></td>
		<td bgcolor="<%=colFormBodyRight%>" width=1><img src="x.gif" width=1 height=24></td>
		...
		<tr><td width=170><p class="ftxt"><% =GetLabel(sCvLanguage, "Subject") %></td>
		<td bgcolor="<%=colFormBodyRight%>" width=1><img src="x.gif" width=1 height=24></td>
		<td bgcolor="<%=colFormBodyText%>" width=407>
		...
		<tr><td width=170><p class="ftxt"><% =GetLabel(sCvLanguage, "Exact title of your degree") %></td>
		<td bgcolor="<%=colFormBodyRight%>" width=1><img src="x.gif" width=1 height=24></td>
		<td bgcolor="<%=colFormBodyText%>" width=407>&nbsp;&nbsp;<input type="text" name="exp_edu_subj1" value="<%=sExpEduSubjectText%>" size="31" style="width:355px;" maxlength="255">&nbsp;&nbsp;<span class="fcmp">*</span>
