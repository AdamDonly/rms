  ...
  <!-- Education -->
	...
	<td width=579 colspan=2 bgcolor="<%=colFormBodyRight%>" valign="top">
		...
		<tr height=20>
			...
			<td width=215 bgcolor="<%=colFormHeaderTop%>"><p><% =GetLabel(sCvLanguage, "Institution") %></p></td>
			...
			<td width=200 bgcolor="<%=colFormHeaderTop%>"><p><% =GetLabel(sCvLanguage, "Subject") %></p></td>
	...
	<td width=578 bgcolor="<%=colFormHeaderTop%>" valign="top">
		...
		<tr><td width=170><p class="ftxt"><% =GetLabel(sCvLanguage, "If needed, please specify the exact title of your degree") %></td>
		<td bgcolor="<%=colFormBodyRight%>" width=1><img src="x.gif" width=1 height=24></td>
