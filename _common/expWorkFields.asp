...
Set objTempRs=GetDataRecordsetPlusOutSP("usp_ExpCvvExperienceCouSelect", Array( _
...
Set objTempRs=GetDataRecordsetPlusOutSP("usp_ExpCvvExperienceDonSelect", Array( _
	Array(, adInteger, , iExpertID), _
	Array(, adInteger, , iExpPrjID), _
	Array(, adVarChar, 10, "rs")), Array( _
	Array(, adVarChar, 4000)))
...
Set objTempRs=GetDataRecordsetPlusOutSP("usp_ExpCvvExperienceSctSelect", Array( _
	Array(, adInteger, , iExpertID), _
	Array(, adInteger, , iExpPrjID), _
	Array(, adVarChar, 10, "rs")), Array( _
	Array(, adVarChar, 4000)))
