...
' Employment records
	...
	While Not objRsExpWke.Eof
		...
		WriteGridDataRow 2, "31%#|#70%", "\b Project title\b0 "  & "#|#" & objRsExpWke("wkePrjTitleEng"), 1, "1#|#1"
		WriteGridDataRow 2, "31%#|#70%", "\b Date\b0 " & "#|#" & ConvertDateForText(objRsExpWke("wkeStartDate"), " ", "MMYYYY") & " - " & sExperienceEndDate, 1, "1#|#1"
		sCountries = GetExpertExperienceCountryList(iCvID, objRsExpWke("id_ExpWke"), sCvLanguage)
		WriteGridDataRow 2, "31%#|#70%", "\b Location\b0 "  & "#|#" & sCountries, 1, "1#|#1"
		...
		WriteGridDataRow 2, "31%#|#70%", "\b Project features\b0 " & "#|#" & ConvertText2RTF(objRsExpWke("wkeProjectDescription")), 1, "1#|#1"
