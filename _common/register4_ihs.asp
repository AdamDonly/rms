...
<html>
<head>
<title>CV registration. Languages</title>
...
function validateForm() {
	if (document.locations.newloc.value=="") {
		alert("Please select your native language"); return;
	}
...
function AddLanguage(cont_next) { 
	if (document.locations.exp_lng_name.selectedIndex==0) {
		alert("Please choose a language.");  return;
	}
	if (document.locations.exp_lng_read.selectedIndex==0 || document.locations.exp_lng_speak.selectedIndex==0 || document.locations.exp_lng_write.selectedIndex==0) {
		alert("Please choose the levels of your knowledge.");   return;
	}
	if (cont_next!=1) {
...
<br/>
  ...
  <!-- Native Languages -->
	...
	<td width=578 bgcolor="<%=colFormHeaderMain%>"><img src="<% =sHomePath %>image/x.gif" width=498 height=1><br><p class="fttl"><img src="<% =sHomePath %>image/<% =imgFormBullet %>" width=7 height=7 align=left vspace=3 hspace=8>NATIVE LANGUAGES</p></td>
	...
	<tr><td width=1 bgcolor="#FFE2E2"><img src="<% =sHomePath %>image/x.gif" width=1 height=1></td>
	<td width=578 bgcolor="<%=colFormHeaderTop%>" valign="top">
		<table border=0 cellspacing=0 cellpadding=0 width="100%">
		<tr><td width=100% valign="top"><p class="ftxt">Click on Add to add a selected language to your list.<br>If you want to remove a language, highlight it and click on Remove</b></td>
		</tr>
		</table>
	</td>
	...
	<td width=578 bgcolor="<%=colFormHeaderTop%>" valign="top">
		...
		<tr><td width=170 valign="top"><p class="ftxt">Languages<br><img src="<% =sHomePath %>image/x.gif" width=140 height=1><br></td>
		...
		&nbsp;&nbsp;&nbsp;<a href="javascript:moveloc(1)">Add</a><br><br><br><a href="javascript:moveloc(0)">Remove</a></p>
		</td>
  ...
  <!-- Foreign Languages -->
	...
	<td width=1 bgcolor="<%=colFormHeaderBottom%>"><img src="<% =sHomePath %>image/x.gif" width=1 height=1></td></tr>
	<tr height=18><td width=1 bgcolor="<%=colFormHeaderTop%>"><img src="<% =sHomePath %>image/x.gif" width=1 height=18></td>
	<td width=578 bgcolor="<%=colFormHeaderMain%>"><img src="<% =sHomePath %>image/x.gif" width=498 height=1><br><p class="fttl"><img src="<% =sHomePath %>image/<% =imgFormBullet %>" width=7 height=7 align=left vspace=3 hspace=8>FOREIGN LANGUAGES</p></td>
	<td width=1 bgcolor="<%=colFormHeaderBottom%>"><img src="<% =sHomePath %>image/x.gif" width=1 height=18></td></tr>
	<tr height=1><td width=1 bgcolor="<%=colFormHeaderTop%>"><img src="<% =sHomePath %>image/x.gif" width=1 height=1></td>
	<td width=578 bgcolor="<%=colFormHeaderBottom%>"><img src="<% =sHomePath %>image/x.gif" width=498 height=1></td>
	<td width=1 bgcolor="<%=colFormHeaderBottom%>"><img src="<% =sHomePath %>image/x.gif" width=1 height=1></td></tr>
	...
	<td width=579 colspan=2 bgcolor="<%=colFormBodyRight%>" valign="top">
		...
		<tr height=20>
			<td width=15 bgcolor="<%=colFormHeaderTop%>"><p>No.</td>
			<td width=240 bgcolor="<%=colFormHeaderTop%>"><p>Language</td>
			<td width=100 bgcolor="<%=colFormHeaderTop%>"><p>Reading</td>
			<td width=100 bgcolor="<%=colFormHeaderTop%>"><p>Speaking</td>
			<td width=100 bgcolor="<%=colFormHeaderTop%>"><p>Writing</td>
		...
		<% i=1
		 while not objTempRs.EOF %>
		  <tr height=20>
		    ...
		    <td bgcolor="<%=colFormBodyText%>"><p><a href="<%=sScriptFileName & AddUrlParams(sParams, "lngid=" & objTempRs("id_ExpLan"))%>&act=update"><% If objTempRs("id_ExpLan")=iExpLngID Then %><b><img src="<% =sHomePath %>image/vn_v.gif" width=8 height=12 border=0 hspace=0 align="left"><% End If %><%=objTempRs("lngNameEng")%></a></td>
...
End If %>
	...
	<td width=578 bgcolor="<%=colFormHeaderTop%>" valign="top">
		<table width="100%" cellspacing=0 cellpadding=0 border=0>
		<tr><td width=170><p class="ftxt">Language</td>
		<td bgcolor="<%=colFormBodyRight%>" width=1><img src="x.gif" width=1 height=24></td>
		...
		<tr><td width=170><p class="ftxt">Reading</td>
		<td bgcolor="<%=colFormBodyRight%>" width=1><img src="x.gif" width=1 height=24></td>
		...
		<tr><td width=170><p class="ftxt">Speaking</td>
		<td bgcolor="<%=colFormBodyRight%>" width=1><img src="x.gif" width=1 height=24></td>
		<td bgcolor="<%=colFormBodyText%>" width=407>
		...
		<tr><td width=170><p class="ftxt">Writing</td>
		<td bgcolor="<%=colFormBodyRight%>" width=1><img src="x.gif" width=1 height=24></td>
		<td bgcolor="<%=colFormBodyText%>" width=407>
		...
		Else
			Response.Write("<option value=" & arrLanguageLevelID(j) & ">"& arrLanguageLevelTitle(j) &"</option>")
		End If
		Next %></select>&nbsp;&nbsp;<span class="fcmp">*</span>
