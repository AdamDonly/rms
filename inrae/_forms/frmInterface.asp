...
sTempParams=ReplaceUrlParams(sTempParams, "srch_orderby")
%>
	...
	<div class="wrapall">
		...
		<tr height="30">
			<td colspan="2" style="background-color:#00847f;">&nbsp;</td>
		</tr>
	...
	<div style="background: rgba(255,255,255,0.8); padding: 10px 0 20px 0;">
...
%>
  	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr height="80">
	<td width="800" bgcolor="#FFFFFF"><a href="<% =sApplicationHomePath & sTempParams %>"><img src="<% =sHomePath %>image/adetef_header.gif" width="800" height="80" border="0"></a></td>
	</td></tr>
	</table>
<%
End Sub
...
%>
	...
	<td width="<%=iFormWidth-2%>" bgcolor="<% =colFormHeaderTop %>"><img src="<%=sHomePath%>image/x.gif" width="<%=iFormWidth-2%>" height=1></td>
	...
	<td width="<%=iFormWidth-2%>" bgcolor="<% =colFormHeaderMain %>"><img src="<%=sHomePath%>image/x.gif" width="<%=iFormWidth-2%>" height=1><br><p class="fttl"><img src="<%=sHomePath%>image/<% =imgFormBullet %>" width=7 height=7 align=left vspace=3 hspace=8><%=sFormTitle%></p></td>
...
%>
	<table width="<%=iFormWidth%>" cellspacing="0" cellpadding="0" border="0"<% If sScriptFileName <> "exp_search.asp" Then %> align="center"<% End If %>>
	<tr height=1><td width=1 bgcolor="<% =colFormHeaderTop %>"></td>
	<td width="<%=iFormWidth-2%>" bgcolor="<% =colFormHeaderTop %>"></td>
	<td width=1 bgcolor="#153B80"></td></tr>

	<tr height=18><td width=1 bgcolor="<% =colFormHeaderTop %>"><img src="<%=sHomePath%>image/x.gif" width=1 height=18></td>
	<td width="<%=iFormWidth-2%>" bgcolor="<% =colFormHeaderMain %>"><p class="fttl"><img src="<%=sHomePath%>image/<% =imgFormBullet %>" width=7 height=7 align=left vspace=3 hspace=8><%=sFormTitle%></p></td>
	<td width=1 bgcolor="#153B80"><img src="<%=sHomePath%>image/x.gif" width=1 height=18></td></tr>

	<tr height=1><td width=1 bgcolor="<% =colFormHeaderTop %>"></td>
	<td width="<%=iFormWidth-2%>" bgcolor="#153B80"></td>
	<td width=1 bgcolor="#153B80"></td></tr>

	<tr height=1><td width=1 bgcolor="#FFFFFF"></td>
	<td width="<%=iFormWidth-2%>" bgcolor="#FFFFFF"></td>
	<td width=1 bgcolor="#FFFFFF"></td></tr>

	<tr><td width=1 bgcolor="#D1E7F7"></td>
	<td width="<%=iFormWidth-2%>" bgcolor="<% =colFormHeaderTop %>" valign="top">
		<table width="100%" cellspacing=0 cellpadding=0 border=0>
<%
End Sub
...
%>
		<tr><td width="<%=iLeftColumnWidth%>"><p class="ftxt"><%=sElementText%></p></td>
		<td bgcolor="<% =colFormBodyRight %>" width=1><img src="<%=sHomePath%>image/x.gif" width=1 height=26></td>
		<td bgcolor="<% =colFormBodyText %>" width=<%=iFormWidth-iLeftColumnWidth%>>&nbsp;&nbsp;<input type="<%=sElementType%>" maxlength="<%=iTextMaxLength%>" name="<%=sElementName%>" size="<%=iWidthSmb%>" style="width:<%=iWidthPx%>px;" <% If sElementValue>"" Then %>value="<%=sElementValue%>"<% End If %> <%=sOtherOptions%>>&nbsp;<% If bCompulsory=1 Then %><span class="rs">*</span><% End If %></td></tr>
<%
End Sub
...
%>
		...
		<td bgcolor="<% =colFormBodyRight %>" width=1><img src="<%=sHomePath%>image/x.gif" width=1 height=<%=iSpaceHeight%>></td>
		<td bgcolor="<% =colFormBodyText %>" width=<%=iFormWidth-iLeftColumnWidth%>></td></tr>
<%
End Sub
...
%>
	...
	<tr height=1><td width=1 bgcolor="#D1E7F7"></td>
	<td width=<%=iFormWidth-2%> bgcolor="<% =colFormHeaderMain %>"></td>
...
%>
	...
	<tr height=1><td width=1 bgcolor="#D1E7F7"></td>
	<td width=348 bgcolor="<% =colFormHeaderMain %>"></td>
	<td width=1 bgcolor="<% =colFormBodyRight %>"></td></tr>
	<tr height=1><td width=1 bgcolor="#FFFFFF"></td>
...
sServiceType=Left(sServiceTypeIn, 3)
	...
	<table width=500 cellspacing=0 cellpadding=0 border=0 align="center" style="background: rgb(255,255,255); background: rgba(255,255,255,1);">
	<tr><td width="10%">&nbsp;</td>
...
<!--			<td><img src="<% =sHomePath %>image/progs_line.gif" width=2 height=42 hspace=5></td> -->
	...
	<tr height=2><td bgcolor="<% =colFormHeaderTop %>"></td></tr>
	</table>
	<% End If %>
<%
End Sub
...
Function GetInformerBox(sText, sColorType)
	GetInformerBox="<table align=""right"" border=0 width=210 cellpadding=0 cellspacing=0><tr><td width=""100%"" bgcolor=""" & colFormHeaderMain & """><table width=210 cellpadding=2 cellspacing=1 border=0><tr><td bgcolor=""#EBF3FE""><p align=""center"">" & sText & "</p></td></tr></table></td></tr></table>"
End Function
%>
