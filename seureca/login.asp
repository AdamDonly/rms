...
<!-- Login -->
	...
	ShowInputFormElement 360, GetLabel(sCvLanguage, "Login name"), "text", "login_name", sLoginName, 50, 200, 0, ""
	ShowInputFormElement 360, GetLabel(sCvLanguage, "Password"), "password", "login_pwd", "", 50, 200, 0, ""
	ShowInputFormSpacer 360, 1
