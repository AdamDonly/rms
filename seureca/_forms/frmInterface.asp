...
%>
	...
	<tr height="80">
	<td width="800" bgcolor="#FFFFFF"><a href="<% =sApplicationHomePath & sTempParams %>"><img src="<% =sHomePath %>image/seureca_header2019.png" width="596" height="81" border="0" vspace="4" style="margin-left: 20%;"></a></td>
	<td>
		<% If iUserID>0 Then %>
