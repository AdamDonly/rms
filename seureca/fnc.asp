...
Function CheckUserLogin(sScriptNameIn)
	If (Not iUserID>0) _
		...
		Or (sApplicationName="backoffice" 	And sUserType<>sApplicationName) _
	...
	Then
		AbandonWrongApplicationSession
		
		If Len(sScriptNameIn)>0 Then sScriptNameIn="?" & sScriptNameIn
		Response.Redirect(sApplicationHomePath & "login.asp" & sScriptNameIn)
	End If
End Function 
...
Function CheckExpertID()
	...
	If sApplicationName<>"expert" Then
		iExpertID=CheckIntegerAndZero(Request.QueryString("id"))
	End If
...
sTmpParams = sParams
sTmpParams = ReplaceUrlParams(sTmpParams, "act=" & sAction)

If iPrevPage > 0 Then
	Response.Write "<td align=""center""><p class=""sml""><a href = """ & sScriptFileName & AddUrlParams(sTmpParams, "page=" & iPrevPage) & """><img src=""" & sImagesFolder & "mprev.gif"" width=7 height=15 hspace=1 vspace=4 border=0 alt=""Previous pages""></a><br>&nbsp;&nbsp;<a href = """ & sScriptFileName & AddUrlParams(sTmpParams, "page=" & iPrevPage) & """>Prev</a>&nbsp;&nbsp;</td>"
End If 
...
For iPage = iStartPage To iEndPage
	...
	Else
		Response.Write "<td align=""center""><p class=""sml""><a href=""" & sScriptFileName & AddUrlParams(sTmpParams, "page=" & iPage) & """><img src=""" & sImagesFolder & "mpage.gif"" width=12 height=15 hspace=2 vspace=3 border=0 alt=""Page " & iPage & """><br>" & iPage & "</a></td>"
	End If
Next

If iNextPage < iTotalPages Then
	Response.Write "<td align=""center""><p class=""sml""><a href = """ & sScriptFileName & AddUrlParams(sTmpParams, "page=" & iNextPage) & """><img src=""" & sImagesFolder & "mnext.gif"" width=7 height=15 hspace=1 vspace=3 border=0 alt=""Next pages""></a><br>&nbsp;&nbsp;<a href = """ & sScriptFileName & AddUrlParams(sTmpParams, "page=" & iNextPage) & """>Next</a>&nbsp;&nbsp;</td>"
End If 
...
Dim sTextTemp
	...
	If Not IsNull(sTextTemp) Then
		...
		sTextTemp=Replace(sTextTemp,"<a","&lt;a")
		sTextTemp=Replace(sTextTemp,"<img","&lt;img")
		sTextTemp=Replace(sTextTemp,"<script","&lt;")
...
'
Function CutStringInMenu(strInput, cnum)
Dim strTemp
	strTemp = strInput
	If Len(strTemp) > cnum Then
	   cp=InStrRev(LEFT(strTemp,cnum), " ")
