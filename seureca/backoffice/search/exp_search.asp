...
<!-- Keywords search -->
	...
	<% ShowInputFormHeader 580, "KEYWORDS SEARCH" %>
		...
		<tr valign="top">
		<td width="170"><nobr>&nbsp;&nbsp;<input type="text" name="srch_firstname" size=13 maxlength=100 style="width:140px;"></nobr></td>
		<td width="220" colspan="2"><nobr>&nbsp;&nbsp;<input type="text" name="srch_surname" size=13 maxlength=100 style="width:200px;"></nobr></td>
		</tr>
		<tr>
	...
	<td width=180 align="center"></td>
		...
		<div class="mini_wraper">
			<%
			' Sectors
			ShowSctScrollBox "<small>" & GetLabel(sCvLanguage, "Sectors of experts' experience") & "</small>",  "", 1, 0, 0 %><br />
			<%
			' Countries
			ShowCouScrollBox "<small>" & GetLabel(sCvLanguage, "Countries of experts' experience") & "</small>",  "", 1, 0, 1, 1, 0 %><br />
			<%			
			'Funding agancies
			ShowDonScrollBox "<small>" & GetLabel(sCvLanguage, "Funding agencies of experts' experience") & "</small>",  "", 1, 0, 0, 0 %><br />
		</div>
