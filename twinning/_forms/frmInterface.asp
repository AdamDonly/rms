...
%>
	...
	<tr height="80">
	<td width="800" bgcolor="#FFFFFF"><a href="<% =sApplicationHomePath & sTempParams %>"><h1 style="padding-left: 50px">Twinning</h1></a></td>
	<td>
		<% If iUserID>0 Then %>
...
Sub ShowUserNoticesViewText(sTitle, sText)
	...
	%>
	<tr>
	<td bgcolor="<%=sTextFrameColor%>" valign="top"><p class="txt"><b><%=sTitle%></b></p></td>
	<td width=1 bgcolor="<%=sTitleColor%>"><img src="/image/x.gif" width=1 height=1><br></td>
