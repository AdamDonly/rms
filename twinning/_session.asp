...
If iUserID>0 Then
	Set objTempRs=GetDataRecordsetSP("usp_LogSessionUserDataSelect", Array( _
		...
		If Not objTempRs.Eof Then
			...
			If InStr(1, objTempRs("UserTypeDescription"), "administrator", vbTextCompare)>0 Then
				iUserAdmin = 1
			Else
				iUserAdmin = 0
			End If
