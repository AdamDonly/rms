...
Dim sIcaServer, sIcaServerType, sIcaServerProtocol, sIcaServerSqlPrefix
sIcaServer = Request.ServerVariables("SERVER_NAME")
If InStr(sIcaServer, "test")>0 Then
	sIcaServerType = "test."
	sIcaServerProtocol = "http://"
	sIcaServerSqlPrefix = "IcaTest_"
Else
	sIcaServerType = "www."
	sIcaServerProtocol = "https://"
	sIcaServerSqlPrefix = "Ica_"
End If
