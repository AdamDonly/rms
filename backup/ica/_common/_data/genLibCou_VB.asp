...
Rem Append data in arrays: mGZnInfo - Geo Zones names, mGZnCode - GeoZones codes
	...
	Response.Write "<br />"
	Response.Write "aGZnInfo(" & (i) & ")=""" & aGZnInfo(i) & """" & vbCrLf & "<br />"
	Response.Write "aGZnCode(" & (i) & ")=" & aGZnCode(i) & vbCrLf & "<br />"
	Response.Write "aGZnContinent(" & (i) & ")=" & aGZnContinent(i) & vbCrLf & "<br />"
	...
	Response.Write "aNtInfo(" & (j+aNt) & ")=""" & aNtInfo(j+aNt) & """" & vbCrLf & "<br />"
	Response.Write "aNtCode(" & (j+aNt) & ")=" & aNtCode(j+aNt) & vbCrLf & "<br />"
	Response.Write "aNtZone(" & (j+aNt) & ")=" & aNtZone(j+aNt) & vbCrLf & "<br />"
		...
		objrs2.Close
		aGZnScroll(i)=j
	Response.Write "aGZnScroll(" & (i) & ")=" & aGZnScroll(i) & vbCrLf & "<br />"
