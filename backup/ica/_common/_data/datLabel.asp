...
dictLabelFrench.Add "Please fill in all the relevant information", "Veuillez compléter toutes les informations importantes et fournir autant de détails que possible sur l’expérience professionnelle."
...
dictLabelEnglish.Add "Year of birth", "Year of birth"
dictLabelFrench.Add "Year of birth", "Année de naissance"
dictLabelSpanish.Add "Year of birth", "Año de nacimiento"

dictLabelFrench.Add "not available in preview", "N'est pas disponible en preview"
'dictLabelSpanish.Add "not available in preview", ""
...
dictLabelFrench.Add "Add nationality", "Cliquez sur <b>ajouter</b> pour ajouter une nationalité choisie à la liste."
...
dictLabelFrench.Add "Add", "Ajouter"
...
dictLabelEnglish.Add "Type of diploma(RTF)", "Type of diploma /\line degree obtained"
dictLabelFrench.Add "Type of diploma(RTF)", "Type de diplôme obtenu"
dictLabelSpanish.Add "Type of diploma(RTF)", "Tipo de diploma obtenido"
...
dictLabelFrench.Add "If needed, please specify the exact title of your diploma", "Si nécessaire spécifiez le titre exact du diplôme"
...
dictLabelFrench.Add "If needed, please specify the exact title of your degree", "Si nécessaire spécifiez le titre exact du diplôme"
...
dictLabelEnglish.Add "Description of tasks(RTF)", "Description of\line the tasks assigned"
dictLabelFrench.Add "Description of tasks(RTF)", "Description\line des tâches assignées"

dictLabelFrench.Add "Funding agency", "Organismes&nbsp;de&nbsp;financement"
...
dictLabelFrench.Add "KEY QUALIFICATION AND SPECIFIC EXPERIENCE", "PRINCIPALES QUALIFICATIONS ET EXPERIENCES SPÉCIFIQUES (PROJETS, ETC)"
...
dictLabelFrench.Add "Other references", "Autres réferences"

dictLabelFrench.Add "Full name", "Nom complet"
...
dictLabelEnglish.Add "Select project's countries (GIP)", "Select countries in which you have worked during this experience"
dictLabelFrench.Add "Select project's countries (GIP)", "Choisissez le ou les pays ou vous avez accompli cette experience"
...
dictLabelFrench.Add "Add selected language", "Sélectionnez la ou les langues maternelles et cliquez sur [ Ajouter ] pour les ajouter à la liste. Si vous souhaitez supprimer une langue, sélectionnez-la et cliquez sur [ Enlever ]."
...
dictLabelFrench.Add "Choose a language and specify your level...", "Choisissez une langue et spécifiez le niveau (lu, parlé, écrit). Pour ajouter une langue cliquez sur [ Ajouter une langue ] et spécifiez à chaque fois les niveaux pour chacune d'entre elles."
...
dictLabelFrench.Add "NATIVE LANGUAGES", "LANGUE MATERNELLE"
dictLabelFrench.Add "Native languages", "Langue maternelle"
...
dictLabelFrench.Add "Mobile", "Téléphone portable / GSM"
...
dictLabelFrench.Add "Please specify availability", "Veuillez spécifier les périodes de disponibilité pendant les deux années à venir. Merci de maintenir  ces informations à jour."
...
dictLabelFrench.Add "Please state your preferences", "Veuillez spécifier vos préférences pour des missions de court et / ou de long terme."
