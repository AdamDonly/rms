...
%>
	...
	<tr height="80">
	<td width="800" bgcolor="#FFFFFF"><a href="<% =sApplicationHomePath & sTempParams %>"><img src="<% =sHomePath %>image/demo_header.jpg" width="346" height="94" border="0" vspace="4"></a></td>
	<td>
		<% If iUserID>0 Then %>
...
%>
	...
	<tr height=1><td width=1 bgcolor="#97CAFB"></td>
	<td width="<%=iFormWidth-2%>" bgcolor="#97CAFB"></td>
	<td width=1 bgcolor="#153B80"></td></tr>

	<tr height=18><td width=1 bgcolor="#97CAFB"><img src="<%=sHomePath%>image/x.gif" width=1 height=18></td>
	<td width="<%=iFormWidth-2%>" bgcolor="#3366CC"><p class="fttl"><img src="<%=sHomePath%>image/<% =imgFormBullet %>" width=7 height=7 align=left vspace=3 hspace=8><%=sFormTitle%></p></td>
	<td width=1 bgcolor="#153B80"><img src="<%=sHomePath%>image/x.gif" width=1 height=18></td></tr>
...
%>
	...
	<td width=<%=iFormWidth-2%> bgcolor="#3366CC"></td>
	<td width=1 bgcolor="#4694E1"></td></tr>
	<tr height=1><td width=1 bgcolor="#FFFFFF"></td>
	<td width=<%=iFormWidth-2%> bgcolor="#FFFFFF"></td>
	<td width=1 bgcolor="#FFFFFF"></td></tr>
...
%>
	...
	<tr height=1><td width=1 bgcolor="#D1E7F7"></td>
	<td width=348 bgcolor="#3366CC"></td>
	<td width=1 bgcolor="#4694E1"></td></tr>
	<tr height=1><td width=1 bgcolor="#FFFFFF"></td>
...
<!--			<td><img src="<% =sHomePath %>image/progs_line.gif" width=2 height=42 hspace=5></td> -->
	...
	<tr height=2><td bgcolor="#97CAFB"></td></tr>
	</table>
	<% End If %>
<%
End Sub
