...
Sub WriteDataRow(sTitle,sValue)
	If sCVFormat="" Then
		Response.Write("\trowd\trgaph90\trleft0\trrh262\trbrdrt \trbrdrl \trbrdrb \trbrdrr \clbrdrl \clbrdrr\brdrs\brdrw10 \cellx2375\cellx8300\pard\intbl\ql\sb20 " & sTitle & "\cell\pard\intbl\ql\sb20 " & sValue & "\cell\pard\intbl\row" & vbCrLf)
	Else
...
If Not IsNull(sRTF) Then
	...
	sRTF=Replace(sRTF,"&#61623;","\line \bullet ")
	sRTF=Replace(sRTF,"&#61607;","\line \bullet ")
	sRTF=Replace(sRTF,"&#61608;","\line \bullet ")
	sRTF=Replace(sRTF,"&#9632;","\line \bullet ")
	sRTF=Replace(sRTF,"&#8722;","\bullet ")
	...
	sRTF=Replace(sRTF,"&#305;","i")
	sRTF=Replace(sRTF,"&#304;","I")
	
	sRTF=Replace(sRTF,"&#1040;","A")
	sRTF=Replace(sRTF,"&#1042;","B")
	sRTF=Replace(sRTF,"&#1045;","E")
	sRTF=Replace(sRTF,"&#1048;","E")
	sRTF=Replace(sRTF,"&#1050;","K")
	sRTF=Replace(sRTF,"&#1053;","H")
	sRTF=Replace(sRTF,"&#1054;","O")
	sRTF=Replace(sRTF,"&#1056;","P")
	sRTF=Replace(sRTF,"&#1057;","C")
	sRTF=Replace(sRTF,"&#1058;","T")
	sRTF=Replace(sRTF,"&#1059;","Y")

	'sRTF=ReplaceHtmlSpecialCodes(sRTF, "\line \bullet ")
