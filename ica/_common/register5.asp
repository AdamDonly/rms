...
<!-- Permanent address -->
	<form method="post" name="RegForm" action="<%=sScriptFileName & sParams %>">
		...
		<h3><% =GetLabel(sCvLanguage, "Permanent address") %></h3>
	...
	<input type="hidden" name="exp_cra_adrid" value="<%=iExpCurrentAddressID%>">
		...
		<div class="box search blue">
		<h3><% =GetLabel(sCvLanguage, "Current address (if different)") %></h3>
		<table class="search_form" width="100%" cellspacing=0 cellpadding=0 border=0>
		<tr>
...
<!-- Current availability -->
		<div class="box search blue">
		<h3><% =GetLabel(sCvLanguage, "Current availability") %></h3>
		<table class="search_form" width="100%" cellspacing=0 cellpadding=0 border=0>
		<tr>
...
<!-- Assignment Preferences -->
		<div class="box search blue">
		<h3><% =GetLabel(sCvLanguage, "Assignment preferences") %></h3>
		<table class="search_form" width="100%" cellspacing=0 cellpadding=0 border=0>
		<tr>
...
<!-- Other section -->
		<div class="box search blue">
		<h3><% =GetLabel(sCvLanguage, "Miscellaneous") %></h3>
		<table class="search_form" width="100%" cellspacing=0 cellpadding=0 border=0>
		<tr>
		...
		<input type="submit" class="red-button w125 under-right-col" name="Continue" value="Save & Continue" onclick="validateForm(); return false;" />
		</div>
		</form>
