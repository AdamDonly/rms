...
Dim sCountries, sDonors, sSectors, iTotalCountries, iTotalDonors, iTotalSectors, bFlagSelected, iTotalProcurementTypes
...
<script language="JavaScript" src="../../../_scripts/js/lib.20201002.js"></script>
<% InsertScrollStyles %>
...
<div align="center">
	...
	<form method="post" action="<%=sScriptFileName & sParams%>" name="RegForm">
		...
		<h3><% =GetLabel(sCvLanguage, "Key qualification and specific experience") %></h3>
	...
	<td colspan=2>
		...
		<th width=30%><p><% =GetLabel(sCvLanguage, "Project / Organisation") %></p></td>
		<th width=40%><p><% =GetLabel(sCvLanguage, "Position") %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p></td>
...
<!--#include file="../_common/expWorkFields.asp"-->
	...
	<input type="hidden" name="mmb_sct_hid" value=''>
		...
		<a href="javascript:AddProject(0);" class="red-button w125 under-right-col-25perc" title="Add this project to the list of managed projects"><% If iExpPrjID>0 Then %>save<% Else %>add<% End If %> project</a>
