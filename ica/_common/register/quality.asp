...
<body>
	...
	<div id="content" class="searchform">
		...
		<div class="colCCCCCC uprCse f17 spc01 botMrgn10">
			<span class="service_title">Curriculum Vitae.</span> Expert ID: <% =objExpertDB.DatabaseCode %><%=iExpertID%>
		</div>
	...
	<input type="hidden" name="id_Expert" value="<% =objExpertDB.DatabaseCode %><% =iExpertID %>">
		...
		<div class="spacebottom">
			<a href="javascript:void(0)" onclick="$(this).closest('form').submit()" class="red-button w115" style="margin-left:180px;">Save & continue</a>
		</div>
		</form>
