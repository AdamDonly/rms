...
Function GetDataRecordsetSPNoParams(sStoredProcedureName)
    Dim objCmd1
    Dim objTempRs
    ...
    Set GetDataRecordsetSPNoParams=objTempRs
...
Function InsertRecordSPWithConn(objConn, sStoredProcedureName, arrParams(), strRV)
Dim rs
Dim objCmd1
