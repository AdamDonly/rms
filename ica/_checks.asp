...
Function CheckboxOnOrZero(sInput)
Dim iResult
	If sInput="on" Or sInput="1" Or Len(sInput)>1 Then 
		iResult = 1
	Else
		iResult = 0
	End If	
	CheckboxOnOrZero=iResult
End Function

Function CheckStringLength(sTextInput, iLength)
	If VarType(sTextInput)<=1 Then sTextInput=""
	
	If Len(sTextInput)>iLength Then
		sTextInput=Left(sTextInput, iLength)
	End If
	CheckStringLength=sTextInput
End Function
%>
